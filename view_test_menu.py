...
class View(Tk):
    ...
    def _create_main_window(self):
        ...
        self.welcome.grid(column=0, row=0, sticky='NEWS')
        # ---------------ask------------------
    ...
    def make_add_item_window(self, parent):
        ...
        try:
            ...
            nm = ''
        self.make_menu_buttons(add_item_frame, nm)
        self.choices = []
    ...
    def make_condiments_beverages_window(self, parent):
        ...
        self.make_menu_buttons(condiments_beverages_frame)
    ...
    def make_sweets_spices_window(self, parent):
        ...
        self.make_menu_buttons(sweets_spices_frame)
    ...
    def make_legumes_nuts_seeds_window(self, parent):
        ...
        self.make_menu_buttons(legumes_nuts_seeds_frame)
    ...
    def make_oils_fats_window(self, parent):
        ...
        self.make_menu_buttons(oils_fats_frame)
    ...
    def make_milk_milk_products_window(self, parent):
        ...
        self.make_menu_buttons(milk_milk_products_frame)
    ...
    def make_cereals_cereal_products_window(self, parent):
        ...
        self.make_menu_buttons(cereals_cereal_products_frame)
    ...
    def make_meat_fish_window(self, parent):
        ...
        menu_frame = ttk.Frame(master_frame)
        menu_frame.grid(column=0, row=0, sticky='news')
        # meat_fish_frame = Frame(master_frame)
        meat_fish_frame = Frame(master_frame, name='meat/ fish')
        meat_fish_frame.grid(column=0, row=0, sticky='news')
        self.make_menu_buttons(menu_frame)
    ...
    def make_fruits_vegetables_window(self, parent):
        ...
        menu_frame = ttk.Frame(master_frame)
        menu_frame.grid(column=0, row=0, sticky='news')
        # fruits_vegetables_frame = Frame(master_frame)
        fruits_vegetables_frame = Frame(master_frame, name='fruits/ vegetables')
        fruits_vegetables_frame.grid(column=0, row=1, sticky='news')
        self.make_menu_buttons(menu_frame)
    ...
    def make_add_window(self, parent):
        self.master_frame = ttk.Frame(parent, name='others')
        self.master_frame.grid(column=0, row=0, sticky='news')
        menu_frame = ttk.Frame(self.master_frame)
        menu_frame.grid(column=0, row=0, sticky='news')
        add_frame = ttk.Frame(self.master_frame)
        # add_frame = ttk.Frame(self.master_frame, name='others')
        add_frame.grid(column=0, row=1, sticky='news')
        self.make_menu_buttons(menu_frame)
        # row0
    ...
    def make_aks_window(self, parent):
        ask = ttk.Frame(parent, name='ask', width=800, height=600)
    ...
    def make_menu_buttons(self, parent, *name_sub):
        ...
        sweets_spices_menu.grid(column=7, row=0, sticky='news')
        ...
        condiments_beverages_menu.grid(column=8, row=0, sticky='news')
        others_menu = Button(parent, text='others',
                                command=lambda action='others': self.controller.action_buttons(action))
        others_menu.grid(column=9, row=0, sticky='news')
        back_menu = Button(parent, text='back',
                           command=self.fall_back_under)
        back_menu.grid(column=10, row=0, sticky='news')

    def _on_start(self):
        self.raise_above_all(self.welcome, '')
        self.frame_stack.pop()
        # with delay 2s
        self.after(2000, lambda: self.raise_above_all(self.ask_frame, ''))
    ...
    def set_values(self, *args):
        if not args:
            ...
            data = args[0][0]
            self.quantity_val.set(data.quantity)
